      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          <div className="order-2 lg:order-1 space-y-4">
            ...
            {/* Get Directions Card */}
            <div className="bg-white rounded-xl border border-gray-200 shadow-xs p-4 hover:shadow-md transition-shadow cursor-pointer">
          ...
          <div className="order-1 lg:order-2">
            ...
            {/* Main Address Card */}
            <div className="bg-white rounded-xl border border-gray-200 shadow-xs p-5 mb-4">
