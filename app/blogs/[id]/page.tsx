  ...
  return (
    <main className="min-h-screen bg-[var(--background)] py-12 lg:py-20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Article Container */}
        <article className="overflow-hidden rounded-3xl border border-[var(--border-highlight)] shadow-sm backdrop-blur-md" style={{ background: 'var(--card-shade)' }}>
           {/* Hero Image & Headline */}
           <div className="relative w-full h-[300px] md:h-[450px]">
              ...
              <div className="absolute bottom-0 left-0 w-full p-6 md:p-12">
                <div className="flex flex-wrap gap-2 mb-4">
                  {blog.tags.map(tag => (
                     <span key={tag} className="px-3 py-1 bg-[var(--accent-5)] text-[var(--accent-1)] text-xs font-bold uppercase tracking-wider rounded-full shadow-sm">
                        {tag}
                     </span>
                  ))}
                </div>
