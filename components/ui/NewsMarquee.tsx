...
import { getNewsMarqueeItems, newsMarqueeConfig } from "@/data/newsMarqueeData";

export const NewsMarquee = () => {
  const combinedList = getNewsMarqueeItems();
    ...
    >
      ...
      <div className="relative flex-1 overflow-hidden mt-20 group">
        ...
        <div
          ...
          style={{ animation: `marqueeVertical ${newsMarqueeConfig.animationDuration}s linear infinite` }}
        >
